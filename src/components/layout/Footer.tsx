...
const Footer: React.FC = () => {
  ...
  return (
  <footer className="relative bg-white/80 backdrop-blur-xl shadow-inner text-gray-800 overflow-hidden border-t border-gray-200">
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-0 right-0 w-96 h-96 bg-gradient-to-tr from-accent-200/30 to-transparent rounded-full blur-3xl opacity-40" />
      </div>
      <div className="container-custom py-10 lg:py-16 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          {/* 회사 정보 */}
          <div>
            <h3 className="text-xl font-bold mb-3 tracking-tight bg-gradient-to-r from-primary-600 to-accent-600 bg-clip-text text-transparent">박신환 행정사 사무소</h3>
          ...
          <div>
            ...
            <div className="space-y-3 text-base text-gray-700">
              ...
              <div className="mt-3 p-3 bg-primary-100/80 rounded-lg">
        ...
        <div className="mt-10 pt-8 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex space-x-5 text-sm text-gray-500">
            ...
            <a href="#" className="hover:text-primary-600 transition-colors">서비스 이용약관</a>
            <a href="#" className="hover:text-primary-600 transition-colors">사이트맵</a>
          </div>
        </div>
      </div>
    </footer>
